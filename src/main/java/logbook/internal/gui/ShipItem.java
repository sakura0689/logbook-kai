...
public class ShipItem {
    ...
    /** 装備1 */
    private ObjectProperty<SlotItem> slot1Item = new SimpleObjectProperty<>();

    /** 装備2 */
    private ObjectProperty<SlotItem> slot2Item = new SimpleObjectProperty<>();

    /** 装備3 */
    private ObjectProperty<SlotItem> slot3Item = new SimpleObjectProperty<>();

    /** 装備4 */
    private ObjectProperty<SlotItem> slot4Item = new SimpleObjectProperty<>();

    /** 装備5 */
    private ObjectProperty<SlotItem> slot5Item = new SimpleObjectProperty<>();

    /** 補強 */
    private ObjectProperty<SlotItem> slotExItem = new SimpleObjectProperty<>();
     ...
     * @return 装備1
     */
    public ObjectProperty<SlotItem> slot1ItemProperty() {
        return this.slot1Item;
    }
     ...
     * @return 装備1
     */
    public SlotItem getSlot1Item() {
        return this.slot1Item.get();
    }
     ...
     * @param slot1Item 装備1
     */
    public void setSlot1Item(SlotItem slot1Item) {
        this.slot1Item.set(slot1Item);
    }
     ...
     * @return 装備2
     */
    public ObjectProperty<SlotItem> slot2ItemProperty() {
        return this.slot2Item;
    }
     ...
     * @return 装備2
     */
    public SlotItem getSlot2Item() {
        return this.slot2Item.get();
    }
     ...
     * @param slot2Item 装備2
     */
    public void setSlot2Item(SlotItem slot2Item) {
        this.slot2Item.set(slot2Item);
    }
     ...
     * @return 装備3
     */
    public ObjectProperty<SlotItem> slot3ItemProperty() {
        return this.slot3Item;
    }
     ...
     * @return 装備3
     */
    public SlotItem getSlot3Item() {
        return this.slot3Item.get();
    }
     ...
     * @param slot3Item 装備3
     */
    public void setSlot3Item(SlotItem slot3Item) {
        this.slot3Item.set(slot3Item);
    }
     ...
     * @return 装備4
     */
    public ObjectProperty<SlotItem> slot4ItemProperty() {
        return this.slot4Item;
    }
     ...
     * @return 装備4
     */
    public SlotItem getSlot4Item() {
        return this.slot4Item.get();
    }
     ...
     * @param slot4Item 装備4
     */
    public void setSlot4Item(SlotItem slot4Item) {
        this.slot4Item.set(slot4Item);
    }
     ...
     * @return 装備5
     */
    public ObjectProperty<SlotItem> slot5ItemProperty() {
        return this.slot5Item;
    }
     ...
     * @return 装備5
     */
    public SlotItem getSlot5Item() {
        return this.slot5Item.get();
    }
     ...
     * @param slot5Item 装備5
     */
    public void setSlot5Item(SlotItem slot5Item) {
        this.slot5Item.set(slot5Item);
    }
     ...
     * @return 補強
     */
    public ObjectProperty<SlotItem> slotExItemProperty() {
     ...
     * @return 補強
     */
    public SlotItem getSlotExItem() {
        return this.slotExItem.get();
    }
     ...
     * @param slotExItem 補強
     */
    public void setSlotExItem(SlotItem slotExItem) {
        this.slotExItem.set(slotExItem);
    }
    ...
    public static ShipItem toShipItem(Ship ship) {
        ...
        shipItem.setSlot1Item(slotItemMap.get(shipItem.getSlot1()));
        shipItem.setSlot2Item(slotItemMap.get(shipItem.getSlot2()));
        shipItem.setSlot3Item(slotItemMap.get(shipItem.getSlot3()));
        shipItem.setSlot4Item(slotItemMap.get(shipItem.getSlot4()));
        shipItem.setSlot5Item(slotItemMap.get(shipItem.getSlot5()));
        shipItem.setSlotExItem(slotItemMap.get(shipItem.getSlotEx()));
